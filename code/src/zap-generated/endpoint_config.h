...
\
\
  /* Endpoint: 0, Cluster: Time Synchronization (server), big-endian */\
\
  /* 8 - UTCTime, */\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
\
  /* 16 - TrustedTimeNodeId, */\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
\
}
...
\
\
  /* Endpoint: 0, Cluster: Time Synchronization (server), little-endian */\
\
  /* 8 - UTCTime, */\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
\
...
\
  /* Endpoint: 0, Cluster: Time Format Localization (server) */ \
  { ZAP_MIN_MAX_DEFAULTS_INDEX(0), 0x00000000, 1, ZAP_TYPE(ENUM8), ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE) }, /* HourFormat */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 }, /* ClusterRevision */  \
\
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(3), 0x00000000, 1, ZAP_TYPE(ENUM8), 0 }, /* Status */  \
...
\
  ...
  { ZAP_LONG_DEFAULTS_INDEX(8), 0x00000000, 8, ZAP_TYPE(EPOCH_US), ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* UTCTime */  \
  { ZAP_SIMPLE_DEFAULT(0x00), 0x00000001, 1, ZAP_TYPE(ENUM8), 0 }, /* Granularity */  \
  { ZAP_LONG_DEFAULTS_INDEX(16), 0x00000003, 8, ZAP_TYPE(NODE_ID), ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* TrustedTimeNodeId */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 }, /* ClusterRevision */  \
\
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x01), 0x00000400, 2, ZAP_TYPE(INT16U), 0 }, /* ac frequency multiplier */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x00000401, 2, ZAP_TYPE(INT16U), 0 }, /* ac frequency divisor */  \
  ...
  { ZAP_SIMPLE_DEFAULT(0xffff), 0x00000509, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* rms current min */  \
  { ZAP_SIMPLE_DEFAULT(0xffff), 0x0000050A, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* rms current max */  \
  { ZAP_SIMPLE_DEFAULT(0xffff), 0x0000050B, 2, ZAP_TYPE(INT16S), 0 }, /* active power */  \
  { ZAP_SIMPLE_DEFAULT(0xffff), 0x0000050C, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* active power min */  \
  { ZAP_SIMPLE_DEFAULT(0xffff), 0x0000050D, 2, ZAP_TYPE(INT16S), ZAP_ATTRIBUTE_MASK(TOKENIZE) }, /* active power max */  \
  { ZAP_SIMPLE_DEFAULT(0x01), 0x00000600, 2, ZAP_TYPE(INT16U), 0 }, /* ac voltage multiplier */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x00000601, 2, ZAP_TYPE(INT16U), 0 }, /* ac voltage divisor */  \
  { ZAP_SIMPLE_DEFAULT(0x01), 0x00000602, 2, ZAP_TYPE(INT16U), 0 }, /* ac current multiplier */  \
  { ZAP_SIMPLE_DEFAULT(1000), 0x00000603, 2, ZAP_TYPE(INT16U), 0 }, /* ac current divisor */  \
  { ZAP_SIMPLE_DEFAULT(0x01), 0x00000604, 2, ZAP_TYPE(INT16U), 0 }, /* ac power multiplier */  \
  { ZAP_SIMPLE_DEFAULT(1000), 0x00000605, 2, ZAP_TYPE(INT16U), 0 }, /* ac power divisor */  \
  { ZAP_SIMPLE_DEFAULT(0), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 18, 254 }, \
  { ZAP_CLUSTER_INDEX(18), 7, 107 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x0000010A,1}}
